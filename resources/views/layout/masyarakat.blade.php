            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarButtonsExample">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link" href="/masyarakat/dashboard">E-Waste</a>
                        </li>
                    </ul>
                    ...
                    <div class="d-flex align-items-center">
                        @if (Route::has('login'))
                            @auth
                                {{-- <a href="/masyarakat/dashboard" class="btn btn-link px-3 me-2">{{ Auth::user()->name }}</a> --}}
                                <div class="dropdown">
                                    <a
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <li>
                                            <a class="dropdown-item" href="/masyarakat/profile">My Profile</a>
                                        </li>
                                        <li>
